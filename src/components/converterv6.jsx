...
function convert(sourceObj, pathMap) {
    ...
    for (const key in sourceObj) {
        if (!pathMap.hasOwnProperty(key)) {
            log.push(`Source key "${key}" found in source but not present in pathMap, not migrated.`);
        }
    }
...
// Inject enabled for consumers?
// "broker":     ""
// "rpc.ping" -> "rpc.ping.enabled" ?? + method
// database enabler if dsn was set
// clickhouse_analytics.export_http_headers -> clickhouse_analytics.export_http_headers.enabled
// clickhouse_analytics.export_grpc_metadata -> clickhouse_analytics.export_grpc_metadata.enabled
...
const pathMap = {
	...
	"proxy_subscribe":               "channel.without_namespace.proxy_subscribe",
	"proxy_publish":                 "channel.without_namespace.proxy_publish",
	"proxy_sub_refresh":             "channel.without_namespace.proxy_sub_refresh",
    ...
    "channel_state_events":    "channel.without_namespace.channel_state_events",
	...
	"rpc_ping":        "rpc.ping",
	"rpc_ping_method": "rpc.ping_method",
    ...
    "proxy_connect_endpoint":          "unified_proxy.connect_endpoint",
    "proxy_refresh_endpoint":          "unified_proxy.refresh_endpoint",
    "proxy_subscribe_endpoint":        "unified_proxy.subscribe_endpoint",
    "proxy_publish_endpoint":          "unified_proxy.publish_endpoint",
    "proxy_sub_refresh_endpoint":      "unified_proxy.sub_refresh_endpoint",
    "proxy_rpc_endpoint":              "unified_proxy.rpc_endpoint",
    "proxy_subscribe_stream_endpoint": "unified_proxy.subscribe_stream_endpoint",

    "proxy_connect_timeout":          "unified_proxy.connect_timeout",
    "proxy_rpc_timeout":              "unified_proxy.rpc_timeout",
    "proxy_refresh_timeout":          "unified_proxy.refresh_timeout",
    "proxy_subscribe_timeout":        "unified_proxy.subscribe_timeout",
    "proxy_publish_timeout":          "unified_proxy.publish_timeout",
    "proxy_sub_refresh_timeout":      "unified_proxy.sub_refresh_timeout",
    "proxy_subscribe_stream_timeout": "unified_proxy.subscribe_stream_timeout",

    "proxy_http_status_code_transforms": "unified_proxy.http.status_code_transforms",
    "proxy_grpc_metadata":               "unified_proxy.grpc_metadata",
    "proxy_http_headers":                "unified_proxy.http_headers",
    "proxy_static_http_headers":         "unified_proxy.http.static_headers",
    "proxy_binary_encoding":             "unified_proxy.binary_encoding",
    "proxy_include_connection_meta":     "unified_proxy.include_connection_meta",
    //"proxy_grpc_cert_file":              "unified_proxy.grpc_cert_file",
    "proxy_grpc_compression":            "unified_proxy.grpc.compression",
    "proxy_grpc_tls":                    "unified_proxy.grpc.tls",

    "proxy_grpc_credentials_key":   "unified_proxy.grpc.credentials_key",
    "proxy_grpc_credentials_value": "unified_proxy.grpc.credentials_value",
    ...
    // "grpc_api_tls_disable":              "grpc_api.tls_disable",
    ...
    "clickhouse_analytics.export_connections":            "clickhouse_analytics.connections.enabled",
    "clickhouse_analytics.export_subscriptions":          "clickhouse_analytics.subscriptions.enabled",
    "clickhouse_analytics.export_operations":             "clickhouse_analytics.operations.enabled",
    "clickhouse_analytics.export_publications":           "clickhouse_analytics.publications.enabled",
    "clickhouse_analytics.export_notifications":          "clickhouse_analytics.notifications.enabled",
    //"clickhouse_analytics.export_http_headers":           []string{},
    // "clickhouse_analytics.export_grpc_metadata":          []string{},
    "clickhouse_analytics.connections_max_buffer_size":   "clickhouse_analytics.connections.max_buffer_size",
    "clickhouse_analytics.operations_max_buffer_size":    "clickhouse_analytics.operations.max_buffer_size",
    "clickhouse_analytics.publications_max_buffer_size":  "clickhouse_analytics.publications.max_buffer_size",
    "clickhouse_analytics.subscriptions_max_buffer_size": "clickhouse_analytics.subscriptions.max_buffer_size",
    "clickhouse_analytics.notifications_max_buffer_size": "clickhouse_analytics.notifications.max_buffer_size",
    "clickhouse_analytics.connections_flush_interval":    "clickhouse_analytics.connections.flush_interval",
    "clickhouse_analytics.operations_flush_interval":     "clickhouse_analytics.operations.flush_interval",
    "clickhouse_analytics.publications_flush_interval":   "clickhouse_analytics.publications.flush_interval",
    "clickhouse_analytics.subscriptions_flush_interval":  "clickhouse_analytics.subscriptions.flush_interval",
    "clickhouse_analytics.notifications_flush_interval":  "clickhouse_analytics.notifications.flush_interval",
    "clickhouse_analytics.connections_flush_size":        "clickhouse_analytics.connections.flush_size",
    "clickhouse_analytics.operations_flush_size":         "clickhouse_analytics.operations.flush_size",
    "clickhouse_analytics.publications_flush_size":       "clickhouse_analytics.publications.flush_size",
    "clickhouse_analytics.subscriptions_flush_size":      "clickhouse_analytics.subscriptions.flush_size",
    "clickhouse_analytics.notifications_flush_size":      "clickhouse_analytics.notifications.flush_size",
    "clickhouse_analytics.connections_ttl":               "clickhouse_analytics.connections.ttl",
    "clickhouse_analytics.operations_ttl":                "clickhouse_analytics.operations.ttl",
    "clickhouse_analytics.publications_ttl":              "clickhouse_analytics.publications.ttl",
    "clickhouse_analytics.subscriptions_ttl":             "clickhouse_analytics.subscriptions.ttl",
    "clickhouse_analytics.notifications_ttl":             "clickhouse_analytics.notifications.ttl",

    "user_tokens_invalidate.enabled":            "user_tokens_invalidate.enabled",
    "user_tokens_invalidate.persistence_engine": "user_tokens_invalidate.persistence_engine",
    "user_block.enabled":                        "user_block.enabled",
    "user_block.persistence_engine":             "user_block.persistence_engine",
    "token_revoke.enabled":                      "token_revoke.enabled",
    "token_revoke.persistence_engine":           "token_revoke.persistence_engine",
    ...
    "push_notifications.queue_engine":                            "redis",
    ...
    "proxy_channel_state_endpoint": "unified_proxy.channel_state_endpoint",
    "proxy_channel_state_timeout":  "unified_proxy.channel_state_timeout",

    "channel_state_vacated_event_delay": "channel_state.vacated_event_delay",
    "partitioned_presence.num_partitions": "channel_state.num_presence_partitions",
    ...
    "proxy_cache_empty_endpoint": "unified_proxy.cache_empty_endpoint",
    "proxy_cache_empty_timeout":  "unified_proxy.cache_empty_timeout",

...
A blog series accompanies this release. The first post — [Shared poll subscriptions — what push can add to poll](https://centrifugal.dev/blog/2026/04/28/shared-poll-subscriptions) — is published today. Five more posts will follow during this week, covering map subscriptions, the PostgreSQL stream broker, the PostgreSQL controller, and a wrap-up tying it all together.
...
- Day 1 (today): [Shared poll subscriptions — what push can add to poll](https://centrifugal.dev/blog/2026/04/28/shared-poll-subscriptions)
- Day 2: Map subscriptions, Part 1 — synchronized key-value state
...
- Wrap-up: Centrifugo, beyond pub/sub — new foundations, and a real-time companion for PostgreSQL

...
**Blog:** [Shared poll subscriptions: O(unique items) polling with low-latency updates](https://centrifugal.dev/blog/2026/05/12/shared-poll-subscriptions)
...
- Day 1 (today): [Shared poll subscriptions: O(unique items) polling with low-latency updates](https://centrifugal.dev/blog/2026/05/12/shared-poll-subscriptions) and [Recreating a Two Million Particle World at 30 Hz with Centrifugo](https://centrifugal.dev/blog/2026/05/12/two-million-particles-on-centrifugo)

...
You can find a description of a test stand with million WebSocket connections in [this blog post](million-connections-with-centrifugo) – though the point above is still valid, measure and monitor your own setup.

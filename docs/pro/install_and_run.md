...
```
docker run --ulimit nofile=65536:65536 -v /host/dir/with/config/file:/centrifugo -p 8000:8000 centrifugo/centrifugo-pro:v4.0.0-beta.1 centrifugo -c config.json
```
...
```
wget https://github.com/centrifugal/centrifugo-pro/releases/download/v4.0.0-beta.1/centrifugo-pro_4.0.0-beta.1-0_amd64.deb
sudo dpkg -i centrifugo-pro_4.0.0-beta.1-0_amd64.deb
```
...
```
wget https://github.com/centrifugal/centrifugo-pro/releases/download/v4.0.0-beta.1/centrifugo-pro-4.0.0-beta.1-0.x86_64.rpm
sudo yum install centrifugo-pro-4.0.0-beta.1-0.x86_64.rpm
```

...
```
docker run --ulimit nofile=262144:262144 -v /host/dir/with/config/file:/centrifugo -p 8000:8000 centrifugo/centrifugo-pro:v5.4.0 centrifugo -c config.json
```
...
```
wget https://github.com/centrifugal/centrifugo-pro/releases/download/v5.4.0/centrifugo-pro_5.4.0_amd64.deb
sudo dpkg -i centrifugo-pro_5.4.0_amd64.deb
```
...
```
wget https://github.com/centrifugal/centrifugo-pro/releases/download/v5.4.0/centrifugo-pro-5.4.0.x86_64.rpm
sudo yum install centrifugo-pro-5.4.0.x86_64.rpm
```

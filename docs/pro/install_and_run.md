...
```
docker run --ulimit nofile=262144:262144 -v /host/dir/with/config/file:/centrifugo -p 8000:8000 centrifugo/centrifugo-pro:v5.0.3 centrifugo -c config.json
```
...
```
wget https://github.com/centrifugal/centrifugo-pro/releases/download/v5.0.3/centrifugo-pro_5.0.3_amd64.deb
sudo dpkg -i centrifugo-pro_5.0.3_amd64.deb
```
...
```
wget https://github.com/centrifugal/centrifugo-pro/releases/download/v5.0.3/centrifugo-pro-5.0.3.x86_64.rpm
sudo yum install centrifugo-pro-5.0.3.x86_64.rpm
```

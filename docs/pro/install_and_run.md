...
```
docker run --ulimit nofile=262144:262144 -v /host/dir/with/config/file:/centrifugo -p 8000:8000 centrifugo/centrifugo-pro:v5.4.1 centrifugo -c config.json
```
...
sudo dpkg -i centrifugo-pro_5.4.1-0_amd64.deb
```
...
sudo yum install centrifugo-pro-5.4.1-0.x86_64.rpm
```

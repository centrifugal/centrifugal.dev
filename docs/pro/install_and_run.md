...
```
docker run --ulimit nofile=262144:262144 -v /host/dir/with/config/file:/centrifugo -p 8000:8000 centrifugo/centrifugo-pro:v5.3.0 centrifugo -c config.json
```
...
```
wget https://github.com/centrifugal/centrifugo-pro/releases/download/v5.3.0/centrifugo-pro_5.1.2_amd64.deb
...
```
wget https://github.com/centrifugal/centrifugo-pro/releases/download/v5.3.0/centrifugo-pro-5.1.2.x86_64.rpm

...
* 📚 [Per-namespace engines](./scalability.md#per-namespace-engines) — assign different brokers per namespace to match backends to features and scale load across separate infrastructure.

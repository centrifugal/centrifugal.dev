---
description: "Centrifugo PRO additional event hooks: channel state events (occupied/vacated) and cache empty events for lazy state population."
id: event_hooks
sidebar_label: Additional event hooks

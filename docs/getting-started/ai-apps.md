...
For the transactional-publishing angle — where the assistant message row and the published event commit together in one PostgreSQL transaction — see the [PostgreSQL stream broker post](/blog/2026/05/01/pg-stream-broker-benefits).

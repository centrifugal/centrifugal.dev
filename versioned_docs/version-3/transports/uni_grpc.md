...
A basic example can be found [here](https://github.com/centrifugal/examples/tree/master/v3/unidirectional/grpc). It uses Go language, but for other languages approach is mostly the same:

...
_centrifugo_latest() {
  curl -s https://api.github.com/repos/centrifugal/centrifugo-pro/releases/latest | grep "tag_name" | awk '{print $2}' | sed 's/[",]//g'
}
...
_download_url() {
  echo "https://github.com/centrifugal/centrifugo-pro/releases/download/$CENTRIFUGO_VERSION/${centrifugoBinary}-pro_${CENTRIFUGO_VERSION#"v"}_${centrifugoOs}_${centrifugoArch}.tar.gz"
}
